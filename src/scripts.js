...
class GitAPI {
    ...
    async commit(name, msg) {
        const randomMsg = COMMIT_MESSAGES[Math.random()*COMMIT_MESSAGES.length|0] || `Random commit message ${Math.random().toString().slice(2)}`;
